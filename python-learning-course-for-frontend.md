...
- 使用 `pytest` 编写基础单元测试。
- 使用 `pandas` 读取、筛选、合并、统计 CSV/Excel/数据库/接口数据。
...
- 每周至少完成一个小项目。
- 从第 14 天开始每天加一个 pandas 小练习，把接口/数据库/CSV 数据变成表格做分析。
...
### 阶段 3.5：pandas 数据处理能力

学习重点：`DataFrame`、读取 CSV/Excel/数据库、筛选、排序、分组统计、表连接、导出报表。

产出：能把后端接口、数据库查询、运营表格变成可分析的数据报表。
